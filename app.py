...
# Define a dictionary to store dog breed data
dogs = [
    {
        'name': 'Maltipoo',
...
# Define a dictionary to store lion data
lions = [
    {
        'name': 'Asiatic Lion',
...
# Define a dictionary to store bear data
bears = [
    {
        'name': 'Polar Bear',
...
# Define a dictionary to store tiger data
tigers = [
    {
        'name': 'Bengal Tiger',
...
# Define a dictionary to store deer data
deers = [
    {
...
@app.route('/tigers')
def get_tigers():
    return jsonify({'tigers': tigers})

@app.route('/deers')
def get_deers():
    return jsonify({'deers': deers})
